...
# Check if 'date' exists in both DataFrames
if 'date' not in actual_df.columns or 'date' not in predicted_df.columns:
    st.error("The 'date' column is missing in one or both of the DataFrames.")
else:
